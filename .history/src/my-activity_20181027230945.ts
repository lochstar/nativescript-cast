...
class MyNativeScriptActivity extends android.support.v4.app.FragmentActivity {
  ...
  public onCreate(savedInstanceState: android.os.Bundle): void {
    ...
    const mCastContext = CastContext.getSharedInstance(this);
    console.log('mCastContext');
    console.dir(mCastContext);
    console.log(mCastContext.isAppVisible());

    // Get strings?
  const CastMediaControlIntent = com.google.andpparoid.gms.cast.CastMediaControlIntent;

...
The plugin comes with an `app.entitlements` which will add this capability the the workspace, however, you must also `Add the Access WiFi information feature to your App ID` . 
